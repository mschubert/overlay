...
[![python:snakemake-interface-logger-plugins](https://repology.org/badge/version-for-repo/gentoo_ovl_science/python:snakemake-interface-logger-plugins.svg?header=python:snakemake-interface-logger-plugins)](https://repology.org/project/python:snakemake-interface-logger-plugins/versions)
...
[![python:snakemake-interface-scheduler-plugins](https://repology.org/badge/version-for-repo/gentoo_ovl_science/python:snakemake-interface-scheduler-plugins.svg?header=python:snakemake-interface-scheduler-plugins)](https://repology.org/project/python:snakemake-interface-scheduler-plugins/versions)
